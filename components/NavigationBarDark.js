  ...
  return (
    <nav className="relative z-20 w-full bg-gray-900/[0.1] bg-opacity-80 backdrop-blur-sm shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        {/* Left section: Logo */}
        <Link href="/">
          {/* You might want a dark mode version of your logo if it has text/colors that clash */}
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/notifications" className="text-gray-100 hover:text-blue-400 font-medium px-3 py-2 rounded-md transition duration-300">Notifications</Link>
            <Link href="/Profilepage" className="text-gray-100 hover:text-blue-400 font-medium px-3 py-2 rounded-md transition duration-300">Profile</Link>
            <Link href="/flight" className="text-gray-100 hover:text-blue-400 font-medium px-3 py-2 rounded-md transition duration-300">Flight</Link>
            <Link href="/hotel/search" className="text-gray-100 hover:text-blue-400 font-medium px-3 py-2 rounded-md transition duration-300">Hotel</Link>
          </div>
